        ...
        http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers("/api/v1/auth/authenticate", "/api/v1/auth/refresh-token", "/api/v1/auth/register-user")
                                ...
                                .requestMatchers(PUT, "/api/v1/category").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
                                .requestMatchers(GET, "/api/v1/category").permitAll()
                                .requestMatchers(POST, "/api/v1/category").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
                                .requestMatchers(PUT, "/api/v1/category/{id}").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
                                .requestMatchers(DELETE, "/api/v1/category/{id}").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
                                .requestMatchers(GET, "/api/v1/products").permitAll()
                                .requestMatchers(PUT, "api/v1/products").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
                                .requestMatchers(POST, "api/v1/products").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
                                .requestMatchers(DELETE, "api/v1/products/{id}").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
                                .requestMatchers(PUT, "api/v1/products/{id}").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
                                .requestMatchers(GET, "api/v1/products/by-category/{categoryId}").permitAll()
                                .requestMatchers(GET, "/api/v1/order-items/all").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
                                ...
                                .requestMatchers(GET, "/api/v1/orders/all-orders").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
                                .requestMatchers(GET, "/api/v1/orders/{orderId}").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
                                .requestMatchers(GET, "/api/v1/orders/new-order").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
